...
struct  LocationServiceStatus_t1429346687 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(LocationServiceStatus_t1429346687, ___value___1)); }
