...
struct  SerializationFormat_t3103014277 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(SerializationFormat_t3103014277, ___value___1)); }
